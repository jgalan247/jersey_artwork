...
MIDDLEWARE = [
    ...
    # 'artworks.security.SecurityMiddleware',  # Comment this out for local testing
    # 'artworks.security.RateLimitMiddleware',  # Comment this out for local testing
]
...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.sqlite3',  # Use SQLite for local testing
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': './logs/error.log',  # Changed to local path
        ...
        'security': {
            'level': 'WARNING',
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': './logs/security.log',  # Changed to local path
            'maxBytes': 1024 * 1024 * 10,  # 10MB
            'backupCount': 10,
            'formatter': 'verbose',
        },
